...
from . import GenericAWGs

import numpy as np

_depends_local=["...core.devio.SCPI",".GenericAWGs"]


AWG33220A=GenericAWGs.Agilent33220A
AWG33550=GenericAWGs.Agilent33500
...
class HP8722D(SCPI.SCPIDevice):
    ...
    def get_channel_format(self):
        for fmt,comm in self._channel_formats.items():
